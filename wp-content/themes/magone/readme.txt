...
Version 4.9.4.9
- New: allow show view count on blocks and single item
...
TODO
====
- Change the way to notify updates to all users (to courage pirated users to purchase) instead of using Envato Market Plugin
- Allow changing [..] at end of snippet of blocks
- Have option for Bloggin Article Block where you can change size of Thumbnail
- Allow show original iamge if gif (animated)
- Check show view count for all widgets
- missing author and update micro data for static page
- attachment page also need full sidebar manager like other pages
- style for logged in woo users: https://scontent-sit4-1.xx.fbcdn.net/v/t35.0-12/18296938_1429315940425211_690413645_o.png?oh=415a6696e1ab4b0187df80b0ba203b80&oe=5909FF82
- show view count
- social lock not work properly, please mirror from https://wordpress.org/plugins/social-locker/
