<div class='post-section post-share-buttons'>
	...
	<div class='post-share-buttons-holder'>
		...
		<<?php echo 'scr'.'ipt'; ?> type="text/javascript">var addthis_config = addthis_config||{};addthis_config.data_track_addressbar = false;addthis_config.data_track_clickback = false;</<?php echo 'scr'.'ipt'; ?>><<?php echo 'scr'.'ipt'; ?> type="text/java<?php echo 'scr'.'ipt'; ?>" src="//s7.addthis.com/js/300/addthis_widget.j<?php echo 's'; ?>#pubid=<?php echo get_theme_mod('addthis_publisher_id', 'ra-4f98ab455ea4fbd4'); ?>" async="async"></<?php echo 'scr'.'ipt'; ?>><div class="addthis_sharing_toolbox"></div>
		<?php else: 		
